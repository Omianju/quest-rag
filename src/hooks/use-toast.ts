...
// Explicitly create the type from actionTypes to use in runtime code
export const ACTION_TYPES = {
  ADD_TOAST: actionTypes.ADD_TOAST,
  UPDATE_TOAST: actionTypes.UPDATE_TOAST,
  DISMISS_TOAST: actionTypes.DISMISS_TOAST,
  REMOVE_TOAST: actionTypes.REMOVE_TOAST,
} as const
